...
public class WebConfig implements WebMvcConfigurer {
    ...
    @Value("${CORS_ALLOWED_ORIGINS_TEST_WWW}")
    private String CORS_ALLOWED_ORIGINS_TEST_WWW;
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**")
                .allowedOrigins("http://10.0.0.136:3000", "http://localhost:3000",
                        CORS_ALLOWED_ORIGINS_PROD, CORS_ALLOWED_ORIGINS_TEST, CORS_ALLOWED_ORIGINS_PROD_WWW, CORS_ALLOWED_ORIGINS_TEST_WWW)
